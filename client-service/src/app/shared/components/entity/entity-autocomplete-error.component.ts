...
@Component({
  selector: 'tb-entity-autocomplete-error',
  templateUrl: './entity-autocomplete-error.component.html',
  styleUrls: ['./entity-autocomplete-error.component.scss'],
  providers: [{
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => EntityAutocompleteErrorComponent),
    multi: true
  }]
})
export class EntityAutocompleteErrorComponent implements ControlValueAccessor, OnInit, AfterViewInit {
